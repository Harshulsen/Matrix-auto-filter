...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002003854855 -1002135572202 -1002087470527 -1002095793843 -1002144234098 -1002008640075').split()]
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/mkvg2')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002003854855 -1002095793843 -1002087470527 -1002135572202 -1002144234098 -1002008640075')).split()]
...
URL = "https://reduced-geri-jadujcgxdc-6af6a98a.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://reduced-geri-jadujcgxdc-6af6a98a.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://reduced-geri-jadujcgxdc-6af6a98a.koyeb.app/".format(FQDN)
else:
    URL = "https://reduced-geri-jadujcgxdc-6af6a98a.koyeb.app/".format(FQDN)
