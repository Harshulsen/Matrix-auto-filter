...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002003854855 -1002095793843 -1002008640075').split()]
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002144234098')).split()]
...
if HAS_SSL:
    URL = "https://matrix-auto-filter-picm.onrender.com/".format(FQDN)
else:
    URL = "https://matrix-auto-filter-picm.onrender.com/".format(FQDN)
