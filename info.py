...
URL = "https://matrix-auto-filter-fqfz.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://matrix-auto-filter-fqfz.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://matrix-auto-filter-fqfz.onrender.com/".format(FQDN)
else:
    URL = "https://matrix-auto-filter-fqfz.onrender.com/".format(FQDN)
