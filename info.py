...
URL = "https://matrix-auto-filter-c9gg.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://matrix-auto-filter-c9gg.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://matrix-auto-filter-c9gg.onrender.com/".format(FQDN)
else:
    URL = "https://matrix-auto-filter-c9gg.onrender.com/".format(FQDN)
