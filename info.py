...
API_ID = int(environ.get('API_ID', '27378631'))
API_HASH = environ.get('API_HASH', '62b24cf4b91a87847b731a8d652cd859')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5874451395').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002003854855 -1002095793843 -1002087470527 -1002008640075').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://harshulsen5:3u71OGDImgdnheeG@cluster0.e1pmacz.mongodb.net/?retryWrites=true&w=majority")
...
SHORTLINK_API = environ.get('SHORTLINK_API', '431513264b4172354ccd3f1b50c929c0baa1f44d')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', False))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/mkvbt')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Mkvmovie01')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/c/2107176528/2')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Hello Nanbha and Nanbis ❤️')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002028514056'))
...
URL = "https://matrix-dn0p.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://matrix-dn0p.onrender.com".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://matrix-dn0p.onrender.com/".format(FQDN)
else:
    URL = "https://matrix-dn0p.onrender.com/".format(FQDN)
